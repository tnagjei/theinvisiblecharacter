...
const forbidden = [
  ...
  /href=["'][^"']*\.html(?:[#?][^"']*)?["']/g,
  /['"`]\/(?:about|about-fr|help|help-fr|tools|developer|index-fr|privacy-policy|terms-of-service|cookie-policy|tiktok-invisible-username-generator|invisible-name-generator|blank-text-generator|discord-invisible-name-generator|whatsapp-blank-message-generator|fortnite-invisible-name-generator|instagram-invisible-character-generator)\.html(?:[#?][^'"`]*)?['"`]/g,
  /['"`]\/fr\/[^'"`]*\.html(?:[#?][^'"`]*)?['"`]/g,
  /['"`]\/blog\/[^'"`]*\.html(?:[#?][^'"`]*)?['"`]/g,
  /['"`]\/index\.html['"`]/g,
  /['"`]\/404\.html['"`]/g
...
if (!fs.existsSync(redirectsPath)) {
  ...
  const requiredRedirects = [
    ...
    '/discord-invisible-name-generator.html /discord-invisible-name-generator 301',
    '/whatsapp-blank-message-generator.html /whatsapp-blank-message-generator 301',
    '/fortnite-invisible-name-generator.html /fortnite-invisible-name-generator 301',
    '/instagram-invisible-character-generator.html /instagram-invisible-character-generator 301',
